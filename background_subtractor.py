...
if __name__ == '__main__':
    ...
    print("Setting WIDTH " + str(capture.set(cv.CAP_PROP_FRAME_WIDTH, 640)))
    ...
    time.sleep(2)
    capture.set("Setting PIXEL FORMAT " + cv.CAP_PROP_FOURCC, cv.VideoWriter_fourcc('M', 'J', 'P', 'G'))
    ...
    print("AUTO_EXPOSURE " + str(capture.get(cv.CAP_PROP_AUTO_EXPOSURE)))
    print("FRAME_WIDTH " + str(capture.get(cv.CAP_PROP_FRAME_WIDTH)))
    print("FRAME_HEIGHT " + str(capture.get(cv.CAP_PROP_FRAME_HEIGHT)))
    time.sleep(2)
